    ...
    <div className="min-h-screen bg-white">
      <div className="bg-brand-teal text-white py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold mb-5">College About: Building Future Dental Leaders</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            <h2 className="text-3xl font-bold text-brand-blue mb-6">Academic Vision</h2>
          ...
          <div>
            <div className="bg-white border border-gray-100 rounded-2xl shadow-sm p-6">
              <h3 className="text-xl font-bold text-brand-blue mb-4">College Snapshot</h3>
