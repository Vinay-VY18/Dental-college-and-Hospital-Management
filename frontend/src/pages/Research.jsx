    ...
    <div className="min-h-screen bg-brand-light">
      ...
      <div className="bg-brand-blue text-white pt-20 pb-32 px-4 text-center">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-black mb-6">Advancing <span className="text-brand-teal">Dental Science</span></h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
              ...
              <div className="space-y-3">
                {['All Fields', 'Oral Surgery', 'Orthodontics', 'Periodontics', 'Implantology'].map(f => (
                  <label key={f} className="flex items-center space-x-3 cursor-pointer group">
                    ...
                    <span className="text-sm text-gray-600 group-hover:text-brand-blue font-medium">{f}</span>
                  </label>
                ))}
              </div>
            </div>
            ...
            <div className="bg-brand-teal p-6 rounded-3xl shadow-xl text-white">
              ...
              <button className="bg-white text-brand-teal w-full py-2 rounded-xl font-black text-xs uppercase tracking-widest hover:bg-gray-50">Enter Portal</button>
            </div>
          </div>
          ...
          <div className="lg:col-span-3 space-y-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-black text-brand-blue text-2xl">Recent Publications</h3>
              <div className="bg-white px-4 py-1.5 rounded-full border text-xs font-bold text-gray-400">Showing {research.length} results</div>
            </div>
            ...
            {loading ? (
                  ...
                  <div key={idx} className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl hover:border-brand-teal transition-all group">
                    <div className="flex flex-col md:flex-row gap-6">
                       ...
                       <div className="flex-1">
                          <span className="text-xs font-black text-brand-teal uppercase tracking-tighter mb-2 block">Clinical Research Paper 2026</span>
                          <h4 className="text-xl font-black text-brand-blue mb-2 hover:text-brand-teal cursor-pointer">{item.title}</h4>
                          <p className="text-sm text-gray-400 font-bold mb-4 flex items-center">
                            <Layers className="mr-2 h-3.5 w-3.5" /> Published By: <span className="text-gray-600 ml-1">{item.authors}</span>
                          </p>
                          <p className="text-gray-600 leading-relaxed line-clamp-2 italic">
                            "{item.description}"
                          </p>
                          <div className="flex gap-4 mt-6">
                             <button className="text-xs font-black text-brand-teal border-b-2 border-brand-teal pb-0.5 hover:text-brand-blue hover:border-brand-blue transition-colors">DOWNLOAD PDF</button>
                             <button className="text-xs font-black text-gray-400 hover:text-brand-blue transition-colors">CITE PUBLICATION</button>
                          </div>
                       </div>
                    </div>
                  </div>
              ...
              <div className="bg-white p-20 rounded-3xl border border-dashed border-gray-300 text-center">
                ...
                <h4 className="text-xl font-black text-gray-400">Library is Empty</h4>
